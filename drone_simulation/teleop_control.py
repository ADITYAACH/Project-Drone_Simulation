...
class TeleopNode(Node):
    def __init__(self) -> None:
        ...
        self.fan_control_publisher = self.create_publisher(Bool, 'fan_control', 10)
    ...
    def toggle_fans(self) -> None:
        ...
        """
        msg = Bool()
        msg.data = True  # Set to True to toggle the fans
        self.fan_control_publisher.publish(msg)
        print("Toggling fans")
